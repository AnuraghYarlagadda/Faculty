...
public class ShowAttActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if (pdfFile.exists()) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                        ...
                        excelPath = FileProvider.getUriForFile(ShowAttActivity.this, "com.example.facultyactivity", pdfFile);
                    } else {
    ...
    private void createPdf(String what) {
        ...
        if (what.equals("present")) {
            ...
            Drawable d =  ResourcesCompat.getDrawable(getResources(), R.drawable.block, null);
